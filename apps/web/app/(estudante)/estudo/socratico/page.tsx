...
export default function SocraticoPage() {
  ...
  async function enviar() {
    ...
    try {
      ...
      // Remove o balão otimista e devolve o texto ao input — nada se perde.
  ...
  return (
    <div className="mx-auto flex h-[calc(100vh-9rem)] w-full max-w-3xl flex-col p-4">
